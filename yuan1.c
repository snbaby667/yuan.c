...
int main(void) {
    ...
    element_clear_Zr(yi);
    element_clear_Zr(hi);
    element_clear_Zr(hix);
    element_clear_Zr(di);
    element_clear_Zr(vi);
    element_clear_Zr(ti);
    element_clear_Zr(ki);
    element_clear_Zr(li);
    element_clear_Zr(kivi);
    element_clear_Zr(kividi);
    element_clear_Zr(kividili);
    element_clear_Zr(taui);
    element_clear_Zr(hi1);
    element_clear_Zr(ki1);
    element_clear_Zr(li1);
    element_clear_Zr(hi2);
    element_clear_Zr(ki2);
    element_clear_Zr(li2);
    element_clear_Zr(tauI);
    element_clear_Zr(sum);

    element_clear_G1(PK);
    element_clear_G1(P);
    element_clear_G1(Yi);
    element_clear_G1(hiPK);
    element_clear_G1(YihiPK);
    element_clear_G1(diP);
    element_clear_G1(Vi);
    element_clear_G1(Ti);
    element_clear_G1(ki1Vi);
    element_clear_G1(ki1ViYi);
    element_clear_G1(T1);
    element_clear_G1(T1li1);
    element_clear_G1(tauiP);
    element_clear_G1(T2);
    element_clear_G1(hi1PK);
    element_clear_G1(ki2ViYi);
    element_clear_G1(hi2PK);
    element_clear_G1(T3);
    element_clear_G1(T3li2);
    element_clear_G1(ci);
    element_clear_G1(sumP);
    element_clear_G1(A1);
    element_clear_G1(ki2Vi);
